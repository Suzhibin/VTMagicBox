...
- (void)subVCChange{//用于演示功能
    if(self.menuInfo.subVCChange==YES){
        self.titleText=@"子视图响应改变了标题";
    }else{
        self.titleText=@"景点介绍，景点介绍，景点介绍。。";
    }
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.titleLabel.text = self.titleText;//@"景点介绍，景点介绍，景点介绍。。";
    return cell;
}
